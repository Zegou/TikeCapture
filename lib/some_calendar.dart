...
import 'package:tike_consumer/some_calendar_page.dart';
import 'package:tike_consumer/some_date_range.dart';
import 'package:tike_consumer/some_utils.dart';
  ...
  SomeCalendarState(
    ...
    if (mode == SomeMode.Range) {
      if (selectedDates == null) {
        ...
        endRangeDate =
            Jiffy(DateTime(now.year, now.month, now.day)).add(days: 2) as DateTime;
      } else {

              ...
              children: <Widget>[
                Column(
                  ...
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Icon(Icons.star,color: /*Theme.of(context).primaryColor*/Color(0xff00c3ff),size: 16.0,),
                        Icon(Icons.star,color: Color(0xff00c3ff),size: 16.0,),
                        Icon(Icons.star,color: Color(0xff00c3ff),size: 16.0,),
                        Icon(Icons.star,color: Color(0xff00c3ff),size: 16.0,),
                        Icon(Icons.star,color: Color(0xff00c3ff),size: 16.0,),
                        SizedBox(width: 20.0,),
                        Text(
                          ...
                          style: TextStyle(color:Colors.grey, fontFamily: 'MontserratRegular'),
                        ),
                ...
                Column(
                      ...
                      children: <Widget>[
                        Text(
                          ...
                          color: /*Colors.yellowAccent*/Color(0xffee7601),
                          fontSize: 18.0
                          ),
                        ),
                        Text(

...
import 'package:tike_consumer/src/themes/light_color.dart';
import 'package:tike_consumer/src/widgets/BottomNavigationBar/bottom_curved_Painter.dart';
        ...
        child: AnimatedContainer(
          ...
          child: AnimatedContainer(
              ...
              decoration: BoxDecoration(
                  color: isEnable ? Colors.black/*LightColor.orange*/ : Colors.black,
                  boxShadow: <BoxShadow>[
                    BoxShadow(
                      color: isEnable ? Colors.black /*Color(0xfffeece2) */: Colors.black/*Colors.white*/,
                      blurRadius: 10,
                      spreadRadius: 5,
                      offset: Offset(5, 5),
                    ),
  ...
  Widget _buildBackground() {
    ...
    return CustomPaint(
      painter: BackgroundCurvePainter(
          ...
          ).transform(_yController.velocity.sign * 0.5 + 0.5),Colors.black
